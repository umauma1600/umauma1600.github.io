...
export default function CafeEntrance() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#1a1510] via-[#2d2318] to-[#1a1510] flex flex-col relative overflow-hidden">
      {/* ヘッダー */}
      <header className="sticky top-0 bg-[#1a1510]/90 backdrop-blur-md shadow-sm z-40 border-b border-amber-700/20">
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
          <Link
            to="/"
            className="text-amber-200/60 hover:text-amber-200 transition-colors flex items-center gap-2"
          >
            <span>←</span>
      ...
      {/* フッター */}
      <footer className="py-6 bg-[#1a1510]/80 border-t border-amber-700/20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <p className="text-amber-600/40 text-xs">
